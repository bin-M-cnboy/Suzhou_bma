...
class LLMInterface:
    ...
    def __init__(self, 
                model: str = "/data0/bma/models/Qwen3-8B", #"gpt-4", 
        ...
        if self.provider == "openai":
            ...
            self.base_url = os.getenv("LOCAL_LLM_URL", "http://localhost:8001/v1")
            self.client = OpenAI(base_url=self.base_url, api_key="vllm-Qwen3-8B-Instruct-123456")
        else:
