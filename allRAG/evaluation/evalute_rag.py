...
def evaluate_rag(retriever, num_questions: int = 5) -> Dict[str, Any]:
    ...
    Returns:
        Dict containing evaluation metrics 包含评估指标的词典
    """
    
    # Initialize LLM
    llm = ChatOpenAI(temperature=0, model_name="/data0/bma/models/Qwen3-8B")
    # /data0/bma/models/Qwen3-8B
    # gpt-4-turbo-preview
