...
def parse_args_llama():
    parser = argparse.ArgumentParser(description="MyModelName")

    parser.add_argument("--model_name", type=str, default='graphrag_llm')
    parser.add_argument("--project", type=str, default="xxx")
    parser.add_argument("--seed", type=int, default=0)

    parser.add_argument("--dataset", type=str, default='CRUD')
    ...
    # LLM related
    parser.add_argument("--llm_model_name", type=str, default='qwen_7b')
    ...
    parser.add_argument("--gnn_out_dim", type=int, default=768)
